...
<body>
	...
	<div class="container" mt-8>
		<div class="card center" style="width: 50rem; margin: auto auto;">
			<div class="card-header text-center">New Compensation</div>
			<div class="card-body">
				<form:form action="saveCompensation" method="post"
					modelAttribute="com">
					<div class="form-outline mb-4">
						<form:input path="id_employee" class="form-control"
							value="${compensation.id_employee}" />
						<label class="form-label" for="form1Example1">UID</label>
					</div>
					<div class="form-outline mb-4">
